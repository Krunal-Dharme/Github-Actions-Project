...
from pipeline_agent.config import Settings, load_settings
from pipeline_agent.github_client import GitHubClient, WorkflowContext, WorkflowRunRef
from pipeline_agent.llm.prompts import AGENT_INVESTIGATION_INPUT
from pipeline_agent.openrouter_client import OpenRouterClient
...
from pipeline_agent.tools.notifications import EmailNotifier, IssueManager
...
# Alias for deliverable naming (§13)
...
def investigate_failure(
    ...
    """Investigate a failed GitHub Actions workflow run (§8 public API)."""
